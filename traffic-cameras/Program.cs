...
while (true)
{
    ...
    var userPrompt = "The image displays a road with trucks and cars. The definition is not great. How many vehicles are present?";
    var msg = new ChatMessage(ChatRole.User, userPrompt);
    msg.Contents.Add(new DataContent(File.ReadAllBytes(output), "image/png"));
    chatHistory.Add(msg);
